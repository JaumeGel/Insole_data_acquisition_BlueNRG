...
#include "SDK_EVAL_Config.h"
 ...
 /**
   * @brief SPI max timeout
   */
 #define SPI_TIMEOUT_MAX  				  700
 ...
 /**
 * @brief  Put the IRQ pin high
 */
#define SDK_EVAL_SPI_IRQ_HIGH()                  GPIO_SetBits(SDK_EVAL_IRQ_SENSOR_PIN)

/**
 * @brief  Put the IRQ pin low
 */
#define SDK_EVAL_SPI_IRQ_LOW()                   GPIO_ResetBits(SDK_EVAL_IRQ_SENSOR_PIN)
