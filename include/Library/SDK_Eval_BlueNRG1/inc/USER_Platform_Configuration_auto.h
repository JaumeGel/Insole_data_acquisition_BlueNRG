...
#define SDK_EVAL_SPI_PERIPH_SENSOR_PIN      s_SpiCs2PinVersion[SdkEvalGetVersion()-1]
#define SDK_EVAL_SPI_PERIPH_SENSOR_MODE     s_SpiCs2ModeVersion[SdkEvalGetVersion()-1]
