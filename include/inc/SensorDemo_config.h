...
/* Number of attributes requests from the sensor demo */
#define NUM_APP_GATT_ATTRIBUTES (14)
...
/* Maximum number of attribute records that can be added to the first application service: Resistive service */
#define MAX_NUMBER_ATTRIBUTES_RECORDS_SERVICE_1 (10)

/* Maximum number of attribute records that can be added to the second application service: Capacitive service */
...
#else
#define ATT_VALUE_ARRAY_SIZE    (43 + 130  + OTA_ATT_VALUE_ARRAY_SIZE) //(GATT + GAP) = 43 (Device Name: BlueNRG) + Acceleration (Acceleration (27) + Free Fall (21) characteristics) +  Environmental Sensor (Temperature (28), Pressure (29)  characteristics)  Services
#endif 
